...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = React7.forwardRef(({
    ...
    return (0, import_jsx_runtime5.jsx)(Tag, {
      ref,
      className: (0, import_classnames3.default)(className, resolvedPrefix),
      ...props
    });
  });
...
var ModalDialog = React8.forwardRef(({
  ...
  return (0, import_jsx_runtime6.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames4.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime6.jsx)("div", {
      className: (0, import_classnames4.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
function useUpdatedRef(value) {
  var valueRef = (0, import_react11.useRef)(value);
...
function useMounted() {
  var mounted = (0, import_react13.useRef)(true);
  var isMounted = (0, import_react13.useRef)(function() {
...
var Modal = (0, import_react17.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime11.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime11.jsx)("div", Object.assign({}, dialogProps, {
    children: React13.cloneElement(children, {
      role: "document"
    })
  }));
  if (Transition2) {
    dialog = (0, import_jsx_runtime11.jsx)(Transition2, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition2) {
      backdropElement = (0, import_jsx_runtime11.jsx)(BackdropTransition2, {
        appear: true,
        in: !!show,
  ...
  return (0, import_jsx_runtime11.jsx)(import_jsx_runtime12.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime13.jsxs)(import_jsx_runtime12.Fragment, {
 ...
 */
//# sourceMappingURL=chunk-W24332WE.js.map
